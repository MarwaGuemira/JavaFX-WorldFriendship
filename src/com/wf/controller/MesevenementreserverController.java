...
/**
 * FXML Controller classMesevenementreserver
 *
 * @author Marwa
 */
public class MesevenementreserverController implements Initializable {
    ...
    //    ReservationService reservationService = new ReservationService();
      ...
      kk = es1.displayById(ee.getEven_id().getIdevenement());
         ...
         LocalDate ki = LocalDate.now();
             ...
             if( kk.getDatedebut().isBefore(ki))
             { OB.add(kk);}
         }
...
//            Image image = new Image(file.toURI().toString());
            ...
            Name.setTextFill(Color.web("#17202A"));
              ...
              int  id5=evt.getIdevenement();
                ...
                Parent page1 = FXMLLoader.load(getClass().getResource("/com/wf/controller/AffichageEvent3.fxml"));
                Scene scene = new Scene(page1);
