 ...
 * @author Marwa
 */
public class MeseventpasserController implements Initializable {
...
//            Image image = new Image(file.toURI().toString());
            ...
            Name.setTextFill(Color.web("#17202A"));
              ...
              int  id5=evt.getIdevenement();
                ...
                Parent page1 = FXMLLoader.load(getClass().getResource("/com/wf/controller/AffichageEvent5.fxml"));
                Scene scene = new Scene(page1);
