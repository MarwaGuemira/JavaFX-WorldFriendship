...
// OB1 =  (ObservableList<participation_evenement>) es1.displayAll1(id50);
 // System.out.println(event);
  for (participation_evenement ee : event){
    ...
    EvenementService l = new EvenementService(); 
    List <Evenement>  event4 = l.displayAll();
...
//            Name.setTextFill(Color.web("#17202A"));
       ...
       //     VBox root3 = new VBox(3);
            ...
            b.setFont(new javafx.scene.text.Font("Arial", 30));
            b.setTextFill(Color.web("#17202A"));
            
            b.setOnAction(new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent event) {
      int     id7 = evt.getIdevenement();
           EvenementService li = new EvenementService();
           Evenement lo = new Evenement(id7);
           li.delete(lo);
...
if (evt.getNbsignal()>3) {
root.getChildren().addAll(IMG, sep, root2,sep3,b);}
