 ...
 * @author Marwa
 */
public class MeseventactuelController implements Initializable {
  ...
  for (participation_evenement ee : event){
    ...
    //  System.out.println(ee.getEven_id());}
      ...
      public Node ListEvent() throws SQLException {
        ...
        int id50 = user.getId();
      //   participation_evenementService k = new participation_evenementService(); 
    List <Evenement>  event2 = es1.displayAllListbyorganisateur(id50);
...
//            Image image = new Image(file.toURI().toString());
            ...
            Name.setTextFill(Color.web("#17202A"));
              ...
              int  id5=evt.getIdevenement();
                ...
                Parent page1 = FXMLLoader.load(getClass().getResource("/com/wf/controller/AffichageEvent4.fxml"));
                Scene scene = new Scene(page1);
